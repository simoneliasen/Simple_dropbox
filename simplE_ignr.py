...
class SimplE_ignr(TensorFactorizer):
	...
	def __init__(self, params, dataset="wn18", save_dir=None):
		TensorFactorizer.__init__(self, model_name="SimplE_ignr", loss_function="likelihood", params=params, dataset=dataset, save_dir=save_dir)
